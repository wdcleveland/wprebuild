...
<style>
  ...
  <div class="container">
  	<div class="row">
        ...
        <div class="row">
          ...
          <div align="center" class="page_team row">
            ...
            while ( $loop->have_posts() ) : $loop->the_post();
              echo '<div class="team_single col-md-6 col-sm-12"><img src="';
              the_field('headshot');
              echo '" alt="';
        ...
        <?php endif; ?> -->
        <a id="" href="<?php echo esc_url( home_url( '/' ) ); ?>admissions/admission-application" class="btn btn-primary">Apply Online</a>
