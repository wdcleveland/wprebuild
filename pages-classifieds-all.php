<?php
/**
 * Template Name: Classifieds (All) Page
  	...
  	<div class="row">
        ...
        <div class="row">
          ...
          <div class="page_calendar ">
            <?php
            $args = array( 'post_type' => 'Classified', 'posts_per_page' => -1, 'orderby' => 'menu_order', 'order' => 'ASC' );
            $loop = new WP_Query( $args );
            while ( $loop->have_posts() ) : $loop->the_post();
              echo '<div class="event_single row"><div class="col-md-12"><em><sup>Type Of Opportunity:</sup></em><h3><a href="';
              esc_url( the_permalink() );
              echo '">';
              the_field('opportunity_type');
              echo '</a></h3><h2 class="event_date_time"><span>Contact Name: </span>';
              the_field('contact_name');
              echo '<h2 class="event_date_time"><span>Address: </span>';
              the_field('address_city');
              echo', ';
              the_field('address_state');
              echo', ';
              the_field('address_province');
              echo'</h2><h2 class="event_date_time"><span>Phone: </span>';
              the_field('contact_phone');
              echo'</h2><h2 class="event_date_time"><span>Email: </span>';
              the_field('contact_email');
              echo'</h2><h2 class="event_date_time"><span>Additional Information: </span>';
              the_field('additional_information');
              echo'</h2><a class="btn btn-primary" href="mailto:';
              the_field('contact_email');
              echo '">Email Contact</a></div></div>';
